...
sys.path.append('/opt/software/github/cellular_histology')
from model_toad import TOAD_fc_mtl_concat, TOAD, OPT_TOAD
...
tokenizer = PreTrainedTokenizerFast.from_pretrained('/opt/software/github/byt5-bio/opt-alphabet')
#net = OPTForCausalLM.from_pretrained('/data/ai/mutation/opt/clm-1.3b/')
net = OPTForCausalLM.from_pretrained('/data/ai/mutation/opt/clm-2m')
#net = OPTForCausalLM.from_pretrained('../enformer/opt-125m-hg38/')
#net = BertForMaskedLM.from_pretrained('../enformer/bert-125m-hg38/')
net = net.to(device)
net.eval()
